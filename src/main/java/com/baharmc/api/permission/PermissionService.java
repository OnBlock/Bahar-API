 ...
 * <p>
 * To use this service to check permissions, get an instance by calling {@link Bahar#getPermissionService()}
...
public interface PermissionService extends OperatorService {
     ...
     */
    boolean hasPermission(@NotNull Permissible permissible, @NotNull String perm);
     ...
     */
    void addPermission(@NotNull Permissible permissible, @NotNull String perm);
     ...
     */
    void removePermission(@NotNull Permissible permissible, @NotNull String perm);
